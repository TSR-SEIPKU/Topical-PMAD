...
public class MyMixMNDEM {
     ...
     */
    public void fit(final MyMixMND initialMixture,
        ...
        while (numIterations++ <= maxIterations &&
            ...
            // Mixture components
            final List<Pair<Double, MyMND>> components
...
//			}
            ...
            fittedModel = new MyMixMND(newWeights,
                                                                    newMeans,
                                                                    newCovMatArrays);
        }
...
//            throw new ConvergenceException();
     ...
     */
    public void fit(MyMixMND initialMixture)
        throws SingularMatrixException,
               NotStrictlyPositiveException {
     ...
     *             of columns
     */
    public static MyMixMND estimate(final double[][] data,
        ...
        final List<Pair<Double, MyMND>> components =
                new ArrayList<Pair<Double, MyMND>>(numComponents);
     ...
     */
    public MyMixMND getFittedModel() {
        return new MyMixMND(fittedModel.getComponents());
    }
